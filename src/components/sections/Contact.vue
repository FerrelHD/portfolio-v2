<template>
  <section
    ...
    class="shrink-0 w-full md:w-screen min-h-[100svh] md:h-dvh flex flex-col justify-between select-none
           ...
           pt-20 pb-8 px-6 md:pt-10 md:pb-10 lg:pt-14 lg:pb-12 md:pl-28 md:pr-16 font-sans"
  >
      ...
      <div class="flex flex-col gap-2.5">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            class="group inline-flex items-center gap-2 text-xs sm:text-sm md:text-base text-[#f3eee8]/75 hover:text-white transition-colors cursor-pointer mt-1 w-fit"
          >
            <svg class="size-4 sm:size-4.5 md:size-5 fill-current opacity-70 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24">
